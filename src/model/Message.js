...
export class Message extends Model{
    ...
    set _id(value){this._data.id = value;}

    //trata o tipo da menssagem
    getViewElement(me){
    ...
    static sendImage(chatId, from, file){
        ...
        return new Promise((resolve, reject)=>{
            ...
            let uploadTask = Firebase.hd().ref(from).child(dateNow+'_'+file.name).put(file);
            ...
            uploadTask.on('state_changed',e=>{
                ...
                let downloadURL = Firebase.hd().ref(from).child(dateNow+'_'+file.name).getDownloadURL().then((url)=>{
    ...
    static send(chatId, from, type, content){
        return new Promise((resolve, reject)=>{
            ...
            Message.getRef(chatId).add({
                ...
                //muda o status para enviado, paramtro 'merge' serve para mesclar o  dado que passei de alteração
                //com os dados ja existente do documento retornado
    ...
    //adiciona os icones e Enviado/Recebido/Lido
